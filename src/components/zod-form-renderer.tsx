...
const StringField = ({
  ...
  <div className="space-y-2">
    <Label htmlFor={fieldName} className="text-xs sm:text-sm font-medium">
    ...
    <Input
      ...
      className={`${error ? "border-red-500" : ""} text-xs sm:text-sm h-8 sm:h-9`}
    />
  ...
  return (
    <div className="space-y-2">
      ...
      <Select value={value} onValueChange={onChange}>
        <SelectTrigger className={`${error ? "border-red-500" : ""} text-xs sm:text-sm h-8 sm:h-9`}>
                  ...
                  <div key={objectFieldName} className="space-y-2">
                    ...
                    {objectFieldSchema instanceof z.ZodBoolean ? (
                      <div className="flex items-center space-x-2">
                        ...
                        />
                        <span className="text-xs sm:text-sm">Enable {objectFieldName}</span>
                      </div>
                    ...
                    {objectFieldError && <p className="text-xs sm:text-sm text-red-500">{objectFieldError}</p>}
                  </div>
                );
              })}
            </div>
