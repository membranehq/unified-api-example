      ...
      <>
        <div className="py-3 whitespace-nowrap">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs sm:text-sm">{record.id}</span>
          </div>
        </div>
        <div className="flex-1 px-2 sm:px-4 py-3 whitespace-nowrap text-xs sm:text-sm">
          {record.createdAt
  ...
  return (
    <div className="border-b border-border hover:bg-muted/50 transition-colors">
      ...
      <div className="flex items-center">
        <div className="px-2 sm:px-4 py-3 whitespace-nowrap">
          <div className="flex items-center gap-2">
            <button
